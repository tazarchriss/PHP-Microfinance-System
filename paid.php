...
<?php
  ...
  if ($_SESSION['id']=='') {
    ...
    WHERE loan.loan_status='Cleared'
                ...
                <main>
                    <div class="container-fluid px-4 mt-2">
                        <ol class="breadcrumb mb-4 text-right">
                            <li class="breadcrumb-item active"><i class="fa fa-file"></i> Manage Loans/Paid Loans</li>
                        </ol>
                        ...
                        <div class="card mb-4">
                           ...
                           <?php     
                            if (mysqli_num_rows($qry1) == 0){
                                ...
                                ?>
                                <h4 class="text-danger text-center">Sorry, there are no cleared loans currently !</h4>
                                ...
                                <td>
                                <h6><?php echo $row['fine']; ?> </h6>
                                
                                </td>
                            
                                <td>
                                <div class="text-center">
                                  <a class="bg-primary p-1 text-light btn btn-sm" href="payment.php?id=<?php echo $row['loan_id'];?>">View Loan</a>
